...
public class AdminCreateStudent extends JPanel implements ActionListener
{
	AdminFrame frame;
	...
	JTextField ucourse1tf,ucourse2tf,ucourse3tf;
	
	public AdminCreateStudent(AdminFrame frame){
		this.frame=frame;
		this.setLayout(null);
	...
	public void actionPerformed(ActionEvent e)
		...
		rs.beforeFirst();
		if(count==3) 
		{String sql = "INSERT INTO `student`( `id`,`password`,`answer`,`name`,`dept`,`course1`,`course2`,`course3`) VALUES ('"+id1+"',"+"'"+s2+"',"+"'"+s3+"',"+"'"+s4+"',"+"'"+s5+"',"+"'"+s6+"',"+"'"+s7+"',"+"'"+s8+"')";
		...
		String sql1="UPDATE `student` SET `id`='"+uid1+"',`password`='"+s2+"',`answer`='"+s3+"',`name`='"+s4+"',`dept`='"+s5+"',`course1`='"+s6+"',`course2`='"+s7+"',`course3`='"+s8+"' WHERE `id`='"+uid1+"'";
		...
		String sql1="DELETE FROM `student` WHERE `id`='"+didtf+"'";
		int a = stmt.executeUpdate(sql1);
		if (a==1)
		{
